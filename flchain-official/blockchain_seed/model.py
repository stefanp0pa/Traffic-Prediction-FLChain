...
class GCN(nn.Module):
    ...
    def __init__(self, nb_block, in_channels, K, nb_chev_filter, nb_time_filter, time_strides, cheb_polynomials_layer_1, cheb_polynomials,num_for_predict, len_input):
